    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=250, unique=True)),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sites', to='generator.categories', verbose_name='Категория')),
                ('under_category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sites', to='generator.under_categories', verbose_name='Под категория')),
            ],
            options={
                'verbose_name': 'Сайт',
